...
async function getExplain(question, answer){
    try {
        const response = await fetch(`http://127.0.0.1:8000/api/explain/${question}/${answer}`, {
            method: "GET",
            headers: {
                'X-CSRFToken': "rbOUQhj5iY88sLgWVJgyEtmVCh6BwWGl"
            }
...
module.exports = {getResponse, postPair, getExplain}